...
var prim_funcs = {
  ...
  "U64.to_nat"        : [1, a=>`${a}`],
  "U64.to_u8"         : [1, a=>`Number(${a})`],
  "U64.to_u16"        : [1, a=>`Number(${a})`],
  "U64.to_u32"        : [1, a=>`Number(${a})`],
  "U64.to_u64"        : [1, a=>`${a}`],
  "U64.to_u128"       : [1, a=>`${a}`],
  "U64.to_u256"       : [1, a=>`${a}`],
  "U64.xor"           : [2, a=>b=>`${a}^${b}`],
  ...
  "U256.to_f64"        : [1, a=>`${a}`],
  "U256.to_nat"        : [1, a=>`${a}`],
  "U256.to_u8"         : [1, a=>`Number(${a})&0xFF`],
  "U256.to_u16"        : [1, a=>`Number(${a})&0xFFFF`],
  "U256.to_u32"        : [1, a=>`Number(${a})&0xFFFFFFFF`],
  "U256.to_u64"        : [1, a=>`${a}`],
  "U256.to_u128"       : [1, a=>`${a}`],
  "U256.to_u256"       : [1, a=>`${a}`],
  "U256.xor"           : [2, a=>b=>`${a}^${b}`],
